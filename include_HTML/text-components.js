...
function renderPrivacyPolicy() {
  return /*html*/ `
   <div id="german" class="d-none">
       <div class=arrow><h1 class="titleH1">Datenschutzerklärung</h1><a id="help-arrow-2" href="/html/summary.html"><img src="/assets/img/arrow-left.png" alt=""></a></div>
       ...
       <p>Verantwortlicher im Sinne der Datenschutzgesetze, insbesondere der EU-Datenschutzgrundverordnung (DSGVO),
        ...
        <p>Name wird im SessionStorage gespeichert</p>
    ...
    <div id="english" >
        ...
        <p>Join-Group-793, represented by
            <br>Dustin Rohrschneider
            <br>Simon Golenia
            <br>René Heller
        </p>
        <h2>Your Rights as a Data Subject</h2>
        <p>Under the provided contact details of our data protection officer, you have the right to exercise the
            following
            rights at any time:
        </p>
        <ul>
            <li>Information about your stored data and its processing (Art. 15 GDPR),</li>
            ...
            <li>Data portability, if you have consented to data processing or have concluded a contract with us (Art. 20
                GDPR).
            </li>
        </ul>
        <p>If you have given us consent, you can revoke it at any time for the future.</p>
        <p>You can lodge a complaint with a supervisory authority at any time, e.g., the competent supervisory authority
            in the
            federal state of your residence or the authority responsible for us as the responsible entity.</p>
        <p>A list of supervisory authorities (for the non-public sector) with address can be found at: <a
                href="https://www.bfdi.bund.de/DE/Service/Anschriften/Laender/Laender-node.html" target="_blank"
                rel="noopener nofollow">https://www.bfdi.bund.de/DE/Service/Anschriften/Laender/Laender-node.html</a>.
        </p>
        <p></p>
        ...
        <p>When you access our website, i.e., if you do not register or otherwise provide information, information of a
            general
            nature is automatically collected. This information (server log files) includes, for example, the type of
            web
            browser, the operating system used, the domain name of your Internet service provider, your IP address, and
            similar.
        </p>
        ...
        <ul>
            ...
            <li>Evaluating the security and stability of the system, and</li>
            <li>Optimizing our website.</li>
        </ul>
        <p>We do not use your data to draw conclusions about your person. This type of information is evaluated
            statistically by
            us, if necessary, in order to optimize our website and the underlying technology.</p>
        <h3>Legal Basis and Legitimate Interest:</h3>
        <p>Processing is carried out in accordance with Art. 6 Para. 1 lit. f GDPR on the basis of our legitimate
            interest in
            improving the stability and functionality of our website.</p>
        <h3>Recipient:</h3>
        <p>Recipients of the data may be technical service providers who act as processors for the operation and
            maintenance of
            our website.</p>
        <p></p>
        <h3>Storage Duration:</h3>
        <p>The data will be deleted as soon as it is no longer necessary for the purpose of collection. This is
            generally the
            case for data used to provide the website when the respective session is ended.</p>
        <p>In the case of data stored in log files, this is the case after at most 14 days. Further storage is possible.
            In this
            case, the IP addresses of the users are anonymized, so that an assignment of the calling client is no longer
            possible.</p>
        <p></p>
        <h3>Provision Required or Necessary:</h3>
        <p>The provision of the aforementioned personal data is neither legally nor contractually required. Without the
            IP
            address, however, the service and functionality of our website cannot be ensured. Additionally, individual
            services
            and features may not be available or may be restricted. For this reason, objection is excluded.</p>
        <p></p>
        <h2>Cookies</h2>
        <p>Like many other websites, we also use so-called "cookies." Cookies are small text files that are stored on
            your
            device (laptop, tablet, smartphone, etc.) when you visit our website.</p>
        <p>You can delete individual cookies or the entire cookie inventory. In addition, you will receive information
            and
            instructions on how these cookies can be deleted or their storage can be blocked in advance. Depending on
            the
            provider of your browser, you can find the necessary information under the following links:</p>
        <ul>
            <li>Mozilla Firefox: <a
                    href="https://support.mozilla.org/de/kb/cookies-loeschen-daten-von-websites-entfernen"
                    target="_blank"
        ...
        <h3>Storage Duration and Used Cookies:</h3>
        <p>If you allow us to use cookies through your browser settings or consent, the following cookies may be used on
            our
            websites:</p>
        <p>Name is stored in sessionStorage</p>
        <h2>Technically Necessary Cookies </h2>
        <h3>Nature and Purpose of Processing:

        </h3>
        <p>We use cookies to make our website more user-friendly. Some elements of our website require that the calling
            browser
            can be identified even after a page change.</p>
        <p>The purpose of using technically necessary cookies is to simplify the use of websites for users. Some
            functions of
            our website cannot be offered without the use of cookies. For these, it is necessary that the browser is
            recognized
            even after a page change.</p>
        ...
        <p>The provision of the aforementioned personal data is neither legally nor contractually required.
            However, without this data, the service and functionality of our website cannot be guaranteed. Additionally,
            certain services and features may not be available or may be restricted.</p>
        <h3>Objection</h3>
        <p>Read the information about your right to object according to Art. 21 GDPR below.</p>
        <p></p>
        <h2>Registration on our website</h2>
        <h3>Nature and purpose of processing:</h3>
        <p>For registration on our website, we require some personal data that is transmitted to us via an input form.
        </p>
        <p>At the time of registration, the following data is also collected:</p>
        <p></p>
        <p>Your registration is necessary for providing certain content and services on our website.</p>
        <h3>Legal basis:</h3>
        <p>The processing of data entered during registration is based on the user's consent (Art. 6(1)(a) GDPR).</p>
        <h3>Recipients:</h3>
        <p>Recipients of the data may be technical service providers who act as processors for the operation and
            maintenance of
            our website.</p>
        <p></p>
        <h3>Storage duration:</h3>
        <p>Data in this context is processed only as long as the corresponding consent is available.</p>
        <h3>Provision required or necessary:</h3>
        <p>The provision of your personal data is voluntary, solely based on your consent. Without providing your
            personal data,
            we cannot grant you access to our offered content.</p>
        <p></p>
        <h2>Comment function</h2>
        <h3>Nature and purpose of processing:</h3>
        <p>When users leave comments on our website, the time of their creation and the user name chosen by the website
            visitor
            are stored in addition to this information. This is for our security, as we can be held responsible for
            illegal
            content on our website, even if created by users.</p>
        <h3>Legal basis:</h3>
        <p>The processing of data entered as a comment is based on a legitimate interest (Art. 6(1)(f) GDPR).</p>
        <p>By providing the comment function, we want to enable uncomplicated interaction. Your information is stored
            for the
            purpose of processing the request and for possible follow-up questions.</p>
        <h3>Recipients:</h3>
        <p>Recipients of the data may be processors.</p>
        <p></p>
        <h3>Storage duration:</h3>
        <p>The data is deleted as soon as it is no longer necessary for the purpose of the collection. This is generally
            the
            case when communication with the user is completed, and the company can infer from the circumstances that
            the matter
            in question has been finally clarified. We reserve the right to delete without stating reasons and without
            prior or
            subsequent information.</p>
        <p>Additionally, you can have your comment deleted by us at any time. Please write an email to the data
            protection
            officer or the person responsible for data protection listed below and provide the link to your comment, as
            well as
            the email address used when creating the comment for identification purposes.</p>
        <h3>Provision required or necessary:</h3>
        <p>The provision of your personal data is voluntary. Without providing your personal data, we cannot grant you
            access to
            our comment function.</p>
        <p></p>
        <h2>Use of script libraries (Google Webfonts)</h2>
        <p>To display our content correctly and graphically appealing across browsers, we use "Google Web Fonts" from
            Google LLC
            (1600 Amphitheatre Parkway, Mountain View, CA 94043, USA; hereinafter "Google") for font display.</p>
        <p>Further information about Google Web Fonts can be found at <a href="https://developers.google.com/fonts/faq"
                rel="noopener nofollow" target="_blank">https://developers.google.com/fonts/faq</a> and in Google's
            privacy
            policy: <a href="https://www.google.com/policies/privacy/" rel="noopener nofollow"
                target="_blank">https://www.google.com/policies/privacy/</a>.</p>
        <p></p>
        <h2>Information about Your Right to Object Pursuant to Art. 21 GDPR</h2>
        <h3>Individual Right to Object</h3>
        <p>You have the right to object at any time, for reasons arising from your particular situation, to the
            processing of
            personal data concerning you, which is carried out based on Art. 6(1)(f) GDPR (processing based on a
            balancing of
            interests); this also applies to profiling based on this provision within the meaning of Art. 4 No. 4 GDPR.
        </p>
        <p>If you file an objection, we will no longer process your personal data unless we can demonstrate compelling
            legitimate grounds for processing that override your interests, rights, and freedoms, or the processing
            serves the
            assertion, exercise, or defense of legal claims.</p>
        ...
        <p>We reserve the right to adjust this privacy statement to ensure that it always complies with current legal
            requirements or to implement changes to our services in the privacy statement, such as the introduction of
            new
            services. The new privacy statement will apply to your renewed visit.</p>

        <h2>Questions to the Data Protection Officer</h2>
        <p>If you have questions about data protection, please write us an email or contact the person responsible for
            data
            protection in our organization directly:</p>
        <p></p>
        <p><em>The privacy policy was created with the assistance of activeMind AG, the experts for
                <a href="https://www.activemind.de/datenschutz/datenschutzbeauftragter/" target="_blank"
                    rel="noopener">external
                    data protection officers.</a> (Version #2020-09-30).</em></p>
    </div>`;
}
...
function renderLegalNotice() {
  return /*html*/ `
    ...
    <div class="arrow"><h1 class="titleH1">Legal Notice</h1> <a id="help-arrow" href="/html/summary.html"><img src="/assets/img/arrow-left.png" alt=""></a></div>
    <h2>Imprint</h2>
    <ul>
        <li>Simon Golenia</li>
        <li>René Heller</li>
...
function renderHelp() {
  return /*html*/ `
    <div class="scroll-help">
    <div class="arrow"><h1 class="titleH1">Help</h1> <a id="help-arrow" href="/html/summary.html"><img src="/assets/img/arrow-left.png" alt=""></a></div>
